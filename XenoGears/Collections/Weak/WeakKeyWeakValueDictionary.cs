...
namespace XenoGears.Collections.Weak
{
    ...
    /// </remarks>
    [DebuggerNonUserCode]
    public sealed class WeakKeyWeakValueDictionary<TKey, TValue> : BaseDictionary<TKey, TValue>
        where TKey : class
        where TValue : class
    {
        ...
        public WeakKeyWeakValueDictionary()
            : this(0, null) { }

        public WeakKeyWeakValueDictionary(int capacity)
            : this(capacity, null) { }

        public WeakKeyWeakValueDictionary(IEqualityComparer<TKey> comparer)
            : this(0, comparer) { }

        public WeakKeyWeakValueDictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
