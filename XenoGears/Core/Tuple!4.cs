...
namespace System
{
    ...
    [Serializable]
    [DebuggerNonUserCode]
    public class Tuple<T1, T2, T3, T4> : ITuple, ITupleImpl
    {
        private T1 m_Item1;
        private T2 m_Item2;
        private T3 m_Item3;
        ...
        public Tuple(T1 item1, T2 item2, T3 item3, T4 item4)
        {
            ...
            this.m_Items = new Object[] { item1, item2, item3, item4 }.ToReadOnly();
        }

        IMutableTuple ITuple.ToMutable() { return ToMutable(); }
        public MutableTuple<T1, T2, T3, T4> ToMutable()
        {
            return MutableTuple.New(m_Item1, m_Item2, m_Item3, m_Item4);
        }
        ...
        public int CompareTo(object other, IComparer comparer)
        {
            ...
            Tuple<T1, T2, T3, T4> tuple = (other as Tuple<T1, T2, T3, T4>).AssertNotNull();
            int num = 0;
