...
namespace XenoGears.Formats.Configuration.Default.Fluent
{
    public class FluentConfig : IFluentSettings<FluentConfig>
    {
        ...
        public FluentConfig(Config config) { Config = config.AssertNotNull(); }
        ...
        public FluentConfig IsPrimitive { get { if (!Config.IsPrimitive) { Config.IsPrimitive = true; Config.DynamicPrimitive = null; } return this; } }
        public FluentConfig IsPrimitiveOf(Func<Object, Object> dynamicPrimitive) { var _ = IsPrimitive; Config.DynamicPrimitive = dynamicPrimitive; return this; }
        public FluentConfig IsNotPrimitive { get { Config.IsPrimitive = false; return this; } }

        public FluentConfig IsObject { get { if (!Config.IsObject) { Config.IsObject = true; Config.Slots = Config.Type.JsonSlots(JsonSlots.Default).ToList(); Config.DynamicObject = null; } return this; } }
        public FluentConfig OptOutPublic { get { Config.IsObject = true; Config.Slots = Config.Type.JsonSlots(JsonSlots.OptOutPublic).ToList(); Config.DynamicObject = null; return this; } }
        public FluentConfig OptOutNonPublic { get { Config.IsObject = true; Config.Slots = Config.Type.JsonSlots(JsonSlots.OptOutNonPublic).ToList(); Config.DynamicObject = null; return this; } }
        public FluentConfig OptIn { get { Config.IsObject = true; Config.Slots = Config.Type.JsonSlots(JsonSlots.OptIn).ToList(); Config.DynamicObject = null; return this; } }
        ...
        public FluentConfig Slots(IEnumerable<MemberInfo> slots) { var _ = IsObject; Config.Slots.AddElements(slots ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        public FluentConfig Slots(Func<Type, IEnumerable<MemberInfo>, IEnumerable<MemberInfo>> slots) { var _1 = IsObject; Config.Slots = (slots ?? ((_2, _3) => Seq.Empty<MemberInfo>()))(Config.Type, Config.Slots).ToList(); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig NotSlots(IEnumerable<MemberInfo> slots) { var _ = IsObject; Config.Slots.RemoveElements(slots ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig Fields(IEnumerable<FieldInfo> fields) { var _ = IsObject; Config.Slots.AddElements(fields ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig NotFields(IEnumerable<FieldInfo> fields) { var _ = IsObject; Config.Slots.RemoveElements(fields ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig Properties(IEnumerable<PropertyInfo> properties) { var _ = IsObject; Config.Slots.AddElements(properties ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig NotProperties(IEnumerable<PropertyInfo> properties) { var _ = IsObject; Config.Slots.RemoveElements(properties ?? Seq.Empty<MemberInfo>()); Config.DynamicObject = null; return this; }
        ...
        public FluentConfig IsObjectOf(Func<Object, Dictionary<String, Object>> dynamicObject) { var _ = IsObject; Config.Slots = null; Config.DynamicObject = dynamicObject; return this; }
        public FluentConfig IsNotObject { get { Config.IsObject = false; Config.Slots = null; Config.DynamicObject = null; return this; } }

        public FluentConfig IsList { get { if (!Config.IsList) { Config.IsList = true; Config.ListElement = null; Config.DynamicList = null; } return this; } }
        public FluentConfig IsListOf(Type listElement) { Config.IsList = true; Config.ListElement = listElement; Config.DynamicList = null; return this; }
        public FluentConfig IsListOf(Func<Type, Type> listElement) { return IsListOf((listElement ?? (_ => null))(Config.Type)); }
        public FluentConfig IsListOf(Func<Object, IEnumerable<Object>> dynamicList) { var _ = IsList; Config.ListElement = null; Config.DynamicList = dynamicList; return this; }
        public FluentConfig IsNotList { get { Config.IsList = false; Config.ListElement = null; Config.DynamicList = null; return this; } }

        public FluentConfig IsHash { get { if (!Config.IsHash) { Config.IsHash = true; Config.HashElement = null; Config.DynamicHash = null; } return this; } }
        public FluentConfig IsHashOf(Type hashElement) { Config.IsHash = true; Config.HashElement = hashElement; Config.DynamicHash = null; return this; }
        public FluentConfig IsHashOf(Func<Type, Type> hashElement) { return IsHashOf((hashElement ?? (_ => null))(Config.Type)); }
        public FluentConfig IsHashOf(Func<Object, Dictionary<Object, Object>> dynamicHash) { var _ = IsHash; Config.HashElement = null; Config.DynamicHash = dynamicHash; return this; }
        public FluentConfig IsNotHash { get { Config.IsHash = false; Config.HashElement = null; Config.DynamicHash = null; return this; } }
    }
}