...
namespace XenoGears.Formats.Engines.Configuration.Fluent
{
    public class MultiFluent : IFluent<MultiFluent>
    {
        ...
        public MultiFluent Slots(Func<IEnumerable<MemberInfo>, IEnumerable<MemberInfo>> slots) { throw new NotImplementedException(); }
        ...
        public MultiFluent NotSlots(Func<IEnumerable<MemberInfo>, IEnumerable<MemberInfo>> slots) { throw new NotImplementedException(); }
        ...
        public MultiFluent Fields(Func<IEnumerable<FieldInfo>, IEnumerable<FieldInfo>> fields) { throw new NotImplementedException(); }
        ...
        public MultiFluent NotFields(Func<IEnumerable<FieldInfo>, IEnumerable<FieldInfo>> fields) { throw new NotImplementedException(); }
        ...
        public MultiFluent Properties(Func<IEnumerable<PropertyInfo>, IEnumerable<PropertyInfo>> properties) { throw new NotImplementedException(); }
        ...
        public MultiFluent NotProperties(Func<IEnumerable<PropertyInfo>, IEnumerable<PropertyInfo>> properties) { throw new NotImplementedException(); }
