...
namespace XenoGears.Formats.Engines.Configuration.Fluent
{
    public class SingleFluent : IFluent<SingleFluent>
    {
        ...
        public SingleFluent Slots(Func<Type, IEnumerable<MemberInfo>> slots) { var _ = IsObject; _metadata.Slots.RemoveElements(slot => slot is MemberInfo); return Slots(slots(_metadata.Type)); }
        ...
        public SingleFluent Slots(Func<IEnumerable<MemberInfo>, IEnumerable<MemberInfo>> slots) { var _ = IsObject; _metadata.Slots = slots(_metadata.Slots).ToList(); return this; }
        public SingleFluent Slots(Func<MemberInfo, bool> slots) { return Slots(_slots => _slots.Where(slots)); }
        public SingleFluent NotSlots(Func<Type, IEnumerable<MemberInfo>> slots) { return NotSlots(slots(_metadata.Type)); }
        ...
        public SingleFluent NotSlots(Func<IEnumerable<MemberInfo>, IEnumerable<MemberInfo>> slots) { return NotSlots(slots(_metadata.Slots)); }
        public SingleFluent NotSlots(Func<MemberInfo, bool> slots) { return NotSlots(_slots => _slots.Where(slots)); }
        public SingleFluent Fields(Func<Type, IEnumerable<FieldInfo>> fields) { var _ = IsObject; _metadata.Slots.RemoveElements(slot => slot is FieldInfo); return Fields(fields(_metadata.Type)); }
        ...
        public SingleFluent Fields(Func<IEnumerable<FieldInfo>, IEnumerable<FieldInfo>> fields) { var _ = IsObject; _metadata.Slots = (Seq.Concat(_metadata.Slots.Where(s => !(s is FieldInfo)), fields(_metadata.Slots.OfType<FieldInfo>()))).ToList(); return this; }
        public SingleFluent Fields(Func<FieldInfo, bool> fields) { return Fields(_fields => _fields.Where(fields)); }
        public SingleFluent NotFields(Func<Type, IEnumerable<FieldInfo>> fields) { return NotFields(fields(_metadata.Type)); }
        ...
        public SingleFluent NotFields(Func<IEnumerable<FieldInfo>, IEnumerable<FieldInfo>> fields) { return NotFields(fields(_metadata.Slots.OfType<FieldInfo>())); }
        public SingleFluent NotFields(Func<FieldInfo, bool> fields) { return NotFields(_fields => _fields.Where(fields)); }
        public SingleFluent Properties(Func<Type, IEnumerable<PropertyInfo>> properties) { var _ = IsObject; _metadata.Slots.RemoveElements(slot => slot is PropertyInfo); return Properties(properties(_metadata.Type)); }
        ...
        public SingleFluent Properties(Func<IEnumerable<PropertyInfo>, IEnumerable<PropertyInfo>> properties) { var _ = IsObject; _metadata.Slots = (Seq.Concat(_metadata.Slots.Where(s => !(s is PropertyInfo)), properties(_metadata.Slots.OfType<PropertyInfo>()))).ToList(); return this; }
        public SingleFluent Properties(Func<PropertyInfo, bool> properties) { return Properties(_properties => _properties.Where(properties)); }
        public SingleFluent NotProperties(Func<Type, IEnumerable<PropertyInfo>> properties) { return NotProperties(properties(_metadata.Type)); }
        ...
        public SingleFluent NotProperties(Func<IEnumerable<PropertyInfo>, IEnumerable<PropertyInfo>> properties) { return NotProperties(properties(_metadata.Slots.OfType<PropertyInfo>())); }
        public SingleFluent NotProperties(Func<PropertyInfo, bool> properties) { return NotProperties(_properties => _properties.Where(properties)); }
        ...
        public SingleFluent IsListOf(Func<Type, Type> listElement) { return IsListOf(listElement(_metadata.Type)); }
        ...
        public SingleFluent IsHashOf(Func<Type, Type> hashElement) { return IsHashOf(hashElement(_metadata.Type)); }
