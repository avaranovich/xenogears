...
namespace System
{
    ...
    [Serializable]
    [DebuggerNonUserCode]
    public class MutableTuple<T1, T2, T3, T4, T5, T6, T7> : IMutableTuple, ITupleImpl
    {
        private T1 m_Item1;
        private T2 m_Item2;
        private T3 m_Item3;
        ...
        public Tuple<T1, T2, T3, T4, T5, T6, T7> ToImmutable()
        {
            return Tuple.New(m_Item1, m_Item2, m_Item3, m_Item4, m_Item5, m_Item6, m_Item7);
        }
        ...
        public int CompareTo(object other, IComparer comparer)
        {
            ...
            MutableTuple<T1, T2, T3, T4, T5, T6, T7> MutableTuple = (other as MutableTuple<T1, T2, T3, T4, T5, T6, T7>).AssertNotNull();
            int num = 0;
            ...
            return comparer.Compare(this.m_Item7, MutableTuple.m_Item7);
        }
        ...
        {
            return TupleImplHelper.CombineHashCodes(new int[] { comparer.GetHashCode(this.m_Item1), comparer.GetHashCode(this.m_Item2), comparer.GetHashCode(this.m_Item3), comparer.GetHashCode(this.m_Item4), comparer.GetHashCode(this.m_Item5), comparer.GetHashCode(this.m_Item6), comparer.GetHashCode(this.m_Item7) });
        }
