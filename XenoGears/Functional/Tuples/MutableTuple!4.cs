...
namespace System
{
    ...
    [Serializable]
    [DebuggerNonUserCode]
    public class MutableTuple<T1, T2, T3, T4> : IMutableTuple, ITupleImpl
    {
        private T1 m_Item1;
        private T2 m_Item2;
        private T3 m_Item3;
        ...
        public Tuple<T1, T2, T3, T4> ToImmutable()
        {
            return Tuple.New(m_Item1, m_Item2, m_Item3, m_Item4);
        }
        ...
        public int CompareTo(object other, IComparer comparer)
        {
            ...
            MutableTuple<T1, T2, T3, T4> MutableTuple = (other as MutableTuple<T1, T2, T3, T4>).AssertNotNull();
            int num = 0;
            ...
            return comparer.Compare(this.m_Item4, MutableTuple.m_Item4);
        }
        ...
        public bool Equals(object other, IEqualityComparer comparer)
        {
            ...
            MutableTuple<T1, T2, T3, T4> MutableTuple = (other as MutableTuple<T1, T2, T3, T4>).AssertNotNull();
            return (((comparer.Equals(this.m_Item1, MutableTuple.m_Item1) && comparer.Equals(this.m_Item2, MutableTuple.m_Item2)) && comparer.Equals(this.m_Item3, MutableTuple.m_Item3)) && comparer.Equals(this.m_Item4, MutableTuple.m_Item4));
        }
        ...
        {
            return TupleImplHelper.CombineHashCodes(new int[] { comparer.GetHashCode(this.m_Item1), comparer.GetHashCode(this.m_Item2), comparer.GetHashCode(this.m_Item3), comparer.GetHashCode(this.m_Item4) });
        }
