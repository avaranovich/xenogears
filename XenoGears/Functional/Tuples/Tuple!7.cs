...
namespace System
{
    ...
    [Serializable]
    [DebuggerNonUserCode]
    public class Tuple<T1, T2, T3, T4, T5, T6, T7> : ITuple, ITupleImpl
    {
        private T1 m_Item1;
        private T2 m_Item2;
        private T3 m_Item3;
        ...
        public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7)
        {
            ...
            this.m_Items = new Object[] { item1, item2, item3, item4, item5, item6, item7 }.ToReadOnly();
        }

        IMutableTuple ITuple.ToMutable() { return ToMutable(); }
        public MutableTuple<T1, T2, T3, T4, T5, T6, T7> ToMutable()
        {
            return MutableTuple.New(m_Item1, m_Item2, m_Item3, m_Item4, m_Item5, m_Item6, m_Item7);
        }
        ...
        public int CompareTo(object other, IComparer comparer)
        {
            ...
            Tuple<T1, T2, T3, T4, T5, T6, T7> tuple = (other as Tuple<T1, T2, T3, T4, T5, T6, T7>).AssertNotNull();
            int num = 0;
